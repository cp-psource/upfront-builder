	...
	public function show_kickstart_notices () {
		...
		if ($this->_has_upfront()) {
			...
			wp_localize_script('kickstart', '_thx_kickstart', array(
				'general_error' => __('Hoppla, etwas ist schief gelaufen.', UpfrontThemeExporter::DOMAIN),
				'success_msg' => __('Alles gut, warte bitte, während wir Dich auf Deine UpFront-Builder-Seite weiterleiten.', UpfrontThemeExporter::DOMAIN),
			));
		} else {
